...
def data_number(fsave, data, newsTime,newsContent, obj, pol, qua):
...
def data_distribute(fobj,fsave, highWeightList, middleWeightList, lowWeightList, degreeHighList, degreeLowList):
    ...
    for every in fobj.readlines():
        ...
        n1, n2, n3, n4, n5, value0 = data_number(fsave, data,newsTime,newsContent,obj, pol, qua)
...
if __name__ == "__main__":
    ...
    fn = '../eFiles/aaPolarity_label_twoKind_test_polarity_DataSet.txt'
    fobj = open(fn, 'r', encoding='utf-8')

    # #people1
    # file = '../eFiles/eaSetQuaValueSencond_people1_quaValue.txt'
    ...
    # people2
    file = '../eFiles/eaSetQuaValueSencond_people2_quaValue.txt'
    fsave = open(file, 'w', encoding='utf-8')
    # 第二种---people2
    firstWeight = 2
    secondWeight = 1.5
